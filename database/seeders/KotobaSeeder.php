...
class KotobaSeeder extends Seeder
{
    public function run()
    {
        ...
        $bab1 = [
            ...
            ['bab_id' => 1, 'jepang' => 'さん', 'kanji' => null, 'romaji' => 'san', 'arti' => 'sapaan (Tn./Ny./Sdr.)', 'kategori' => 'Kata Ganti', 'urutan' => 5],
            ['bab_id' => 1, 'jepang' => 'ちゃん', 'kanji' => null, 'romaji' => 'chan', 'arti' => 'sapaan akrab', 'kategori' => 'Kata Ganti', 'urutan' => 6],
            ['bab_id' => 1, 'jepang' => 'じん', 'kanji' => '人', 'romaji' => 'jin', 'arti' => 'orang ~ (kebangsaan)', 'kategori' => 'Kata Ganti', 'urutan' => 7],
            ['bab_id' => 1, 'jepang' => 'せんせい', 'kanji' => '先生', 'romaji' => 'sensei', 'arti' => 'guru/dosen', 'kategori' => 'Pekerjaan', 'urutan' => 8],
            ['bab_id' => 1, 'jepang' => 'きょうし', 'kanji' => '教師', 'romaji' => 'kyoushi', 'arti' => 'pengajar/guru', 'kategori' => 'Pekerjaan', 'urutan' => 9],
            ['bab_id' => 1, 'jepang' => 'がくせい', 'kanji' => '学生', 'romaji' => 'gakusei', 'arti' => 'murid/pelajar', 'kategori' => 'Pekerjaan', 'urutan' => 10],
            ['bab_id' => 1, 'jepang' => 'かいしゃいん', 'kanji' => '会社員', 'romaji' => 'kaishain', 'arti' => 'karyawan perusahaan', 'kategori' => 'Pekerjaan', 'urutan' => 11],
            ...
            ['bab_id' => 1, 'jepang' => 'だいがく', 'kanji' => '大学', 'romaji' => 'daigaku', 'arti' => 'universitas/kampus', 'kategori' => 'Tempat', 'urutan' => 16],
            ...
            ['bab_id' => 1, 'jepang' => 'さい', 'kanji' => '歳', 'romaji' => 'sai', 'arti' => 'tahun (umur)', 'kategori' => 'Umur', 'urutan' => 20],
            ...
            ['bab_id' => 1, 'jepang' => 'いいえ', 'kanji' => null, 'romaji' => 'iie', 'arti' => 'tidak/bukan', 'kategori' => 'Ekspresi', 'urutan' => 24],
            ...
            ['bab_id' => 1, 'jepang' => 'しつれいですが', 'kanji' => '失礼ですが', 'romaji' => 'shitsurei desu ga', 'arti' => 'permisi/maaf', 'kategori' => 'Ekspresi', 'urutan' => 28],
            ['bab_id' => 1, 'jepang' => 'おなまえは', 'kanji' => 'お名前は', 'romaji' => 'onamae wa', 'arti' => 'siapa nama?', 'kategori' => 'Kata Tanya', 'urutan' => 29],
            ['bab_id' => 1, 'jepang' => 'こちらは…さんです', 'kanji' => null, 'romaji' => 'kochira wa...san desu', 'arti' => 'ini adalah Tn/Ny...', 'kategori' => 'Ungkapan', 'urutan' => 30],
            ...
            ['bab_id' => 1, 'jepang' => 'かんこく', 'kanji' => '韓国', 'romaji' => 'kankoku', 'arti' => 'Korea Selatan', 'kategori' => 'Negara', 'urutan' => 35],
        ...
        // =============================================
        // BAB 2 (46 kata + 30 kata keluarga = 76 kata)
        // =============================================
        $bab2 = [
            // Kata Tunjuk (1-6)
            ...
            // Bahasa (33-35)
            ['bab_id' => 2, 'jepang' => 'えいご', 'kanji' => '英語', 'romaji' => 'eigo', 'arti' => 'bahasa Inggris', 'kategori' => 'Bahasa', 'urutan' => 33],
            ['bab_id' => 2, 'jepang' => 'にほんご', 'kanji' => '日本語', 'romaji' => 'nihongo', 'arti' => 'bahasa Jepang', 'kategori' => 'Bahasa', 'urutan' => 34],
            ...
            ['bab_id' => 2, 'jepang' => 'あのう', 'kanji' => null, 'romaji' => 'anou', 'arti' => 'permisi/anu', 'kategori' => 'Ekspresi', 'urutan' => 38],
            ['bab_id' => 2, 'jepang' => 'えっ', 'kanji' => null, 'romaji' => 'e', 'arti' => 'hah/eh', 'kategori' => 'Ekspresi', 'urutan' => 39],
            ['bab_id' => 2, 'jepang' => 'どうぞ', 'kanji' => null, 'romaji' => 'douzo', 'arti' => 'silakan', 'kategori' => 'Ekspresi', 'urutan' => 40],
            ['bab_id' => 2, 'jepang' => 'どうも、ありがとうございます', 'kanji' => null, 'romaji' => 'doumo arigatou gozaimasu', 'arti' => 'terima kasih banyak', 'kategori' => 'Salam', 'urutan' => 41],
            ...
            ['bab_id' => 2, 'jepang' => 'あ', 'kanji' => null, 'romaji' => 'a', 'arti' => 'ah/oh', 'kategori' => 'Ekspresi', 'urutan' => 44],
            ['bab_id' => 2, 'jepang' => 'これから、おせわになります', 'kanji' => 'これから、お世話になります', 'romaji' => 'korekara osewa ni narimasu', 'arti' => 'mulai sekarang mohon bantuannya', 'kategori' => 'Salam', 'urutan' => 45],
            ['bab_id' => 2, 'jepang' => 'こちらこそ、どうぞ、よろしくおねがいします', 'kanji' => 'こちらこそ、どうぞ、よろしくお願いします', 'romaji' => 'kochirakoso douzo yoroshiku onegaishimasu', 'arti' => 'saya juga mohon bantuannya', 'kategori' => 'Salam', 'urutan' => 46],
            // Keluarga Sendiri (47-61)
            ['bab_id' => 2, 'jepang' => 'ちち', 'kanji' => '父', 'romaji' => 'chichi', 'arti' => 'ayah (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 47],
            ['bab_id' => 2, 'jepang' => 'はは', 'kanji' => '母', 'romaji' => 'haha', 'arti' => 'ibu (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 48],
            ['bab_id' => 2, 'jepang' => 'そふ', 'kanji' => '祖父', 'romaji' => 'sofu', 'arti' => 'kakek (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 49],
            ['bab_id' => 2, 'jepang' => 'そぼ', 'kanji' => '祖母', 'romaji' => 'sobo', 'arti' => 'nenek (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 50],
            ['bab_id' => 2, 'jepang' => 'あに', 'kanji' => '兄', 'romaji' => 'ani', 'arti' => 'kakak laki-laki (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 51],
            ['bab_id' => 2, 'jepang' => 'あね', 'kanji' => '姉', 'romaji' => 'ane', 'arti' => 'kakak perempuan (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 52],
            ['bab_id' => 2, 'jepang' => 'おとうと', 'kanji' => '弟', 'romaji' => 'otouto', 'arti' => 'adik laki-laki (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 53],
            ['bab_id' => 2, 'jepang' => 'いもうと', 'kanji' => '妹', 'romaji' => 'imouto', 'arti' => 'adik perempuan (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 54],
            ['bab_id' => 2, 'jepang' => 'おっと', 'kanji' => '夫', 'romaji' => 'otto', 'arti' => 'suami (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 55],
            ['bab_id' => 2, 'jepang' => 'つま', 'kanji' => '妻', 'romaji' => 'tsuma', 'arti' => 'istri (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 56],
            ['bab_id' => 2, 'jepang' => 'むすこ', 'kanji' => '息子', 'romaji' => 'musuko', 'arti' => 'anak laki-laki (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 57],
            ['bab_id' => 2, 'jepang' => 'むすめ', 'kanji' => '娘', 'romaji' => 'musume', 'arti' => 'anak perempuan (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 58],
            ['bab_id' => 2, 'jepang' => 'おじ', 'kanji' => '伯父/叔父', 'romaji' => 'oji', 'arti' => 'paman (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 59],
            ['bab_id' => 2, 'jepang' => 'おば', 'kanji' => '伯母/叔母', 'romaji' => 'oba', 'arti' => 'bibi (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 60],
            ['bab_id' => 2, 'jepang' => 'いとこ', 'kanji' => '従兄弟/従姉妹', 'romaji' => 'itoko', 'arti' => 'sepupu (saya)', 'kategori' => 'Keluarga Sendiri', 'urutan' => 61],
            // Keluarga Orang Lain (62-76)
            ['bab_id' => 2, 'jepang' => 'おとうさん', 'kanji' => 'お父さん', 'romaji' => 'otousan', 'arti' => 'ayah (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 62],
            ['bab_id' => 2, 'jepang' => 'おかあさん', 'kanji' => 'お母さん', 'romaji' => 'okaasan', 'arti' => 'ibu (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 63],
            ['bab_id' => 2, 'jepang' => 'おじいさん', 'kanji' => null, 'romaji' => 'ojiisan', 'arti' => 'kakek (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 64],
            ['bab_id' => 2, 'jepang' => 'おばあさん', 'kanji' => null, 'romaji' => 'obaasan', 'arti' => 'nenek (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 65],
            ['bab_id' => 2, 'jepang' => 'おにいさん', 'kanji' => 'お兄さん', 'romaji' => 'oniisan', 'arti' => 'kakak laki-laki (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 66],
            ['bab_id' => 2, 'jepang' => 'おねえさん', 'kanji' => 'お姉さん', 'romaji' => 'oneesan', 'arti' => 'kakak perempuan (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 67],
            ['bab_id' => 2, 'jepang' => 'おとうとさん', 'kanji' => '弟さん', 'romaji' => 'otoutosan', 'arti' => 'adik laki-laki (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 68],
            ['bab_id' => 2, 'jepang' => 'いもうとさん', 'kanji' => '妹さん', 'romaji' => 'imoutosan', 'arti' => 'adik perempuan (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 69],
            ['bab_id' => 2, 'jepang' => 'ごしゅじん', 'kanji' => 'ご主人', 'romaji' => 'goshujin', 'arti' => 'suami (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 70],
            ['bab_id' => 2, 'jepang' => 'おくさん', 'kanji' => '奥さん', 'romaji' => 'okusan', 'arti' => 'istri (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 71],
            ['bab_id' => 2, 'jepang' => 'むすこさん', 'kanji' => '息子さん', 'romaji' => 'musukosan', 'arti' => 'anak laki-laki (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 72],
            ['bab_id' => 2, 'jepang' => 'おじょうさん', 'kanji' => 'お嬢さん', 'romaji' => 'ojousan', 'arti' => 'anak perempuan (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 73],
            ['bab_id' => 2, 'jepang' => 'おじさん', 'kanji' => '伯父さん/叔父さん', 'romaji' => 'ojisan', 'arti' => 'paman (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 74],
            ['bab_id' => 2, 'jepang' => 'おばさん', 'kanji' => '伯母さん/叔母さん', 'romaji' => 'obasan', 'arti' => 'bibi (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 75],
            ['bab_id' => 2, 'jepang' => 'いとこさん', 'kanji' => null, 'romaji' => 'itokosan', 'arti' => 'sepupu (orang lain)', 'kategori' => 'Keluarga Orang Lain', 'urutan' => 76],
        ];
        ...
        $bab3 = [
            ...
            ['bab_id' => 3, 'jepang' => 'あそこ', 'kanji' => null, 'romaji' => 'asoko', 'arti' => 'di sana (jauh)', 'kategori' => 'Kata Tunjuk', 'urutan' => 3],
            ...
            ['bab_id' => 3, 'jepang' => 'へや', 'kanji' => '部屋', 'romaji' => 'heya', 'arti' => 'kamar/ruangan', 'kategori' => 'Tempat', 'urutan' => 15],
            ['bab_id' => 3, 'jepang' => 'トイレ(おてあらい)', 'kanji' => 'お手洗い', 'romaji' => 'toire (otearai)', 'arti' => 'toilet', 'kategori' => 'Tempat', 'urutan' => 16],
            ...
            ['bab_id' => 3, 'jepang' => 'じどうはんばいき', 'kanji' => '自動販売機', 'romaji' => 'jidouhanbaiki', 'arti' => 'mesin penjual otomatis', 'kategori' => 'Benda', 'urutan' => 20],
            ...
            ['bab_id' => 3, 'jepang' => 'ワイン', 'kanji' => null, 'romaji' => 'wain', 'arti' => 'anggur/wine', 'kategori' => 'Minuman', 'urutan' => 27],
            ['bab_id' => 3, 'jepang' => 'うりば', 'kanji' => '売り場', 'romaji' => 'uriba', 'arti' => 'tempat penjualan', 'kategori' => 'Tempat', 'urutan' => 28],
            ['bab_id' => 3, 'jepang' => 'ちか', 'kanji' => '地下', 'romaji' => 'chika', 'arti' => 'bawah tanah', 'kategori' => 'Tempat', 'urutan' => 29],
            ['bab_id' => 3, 'jepang' => 'かい(がい)', 'kanji' => '階', 'romaji' => 'kai (gai)', 'arti' => 'lantai ~', 'kategori' => 'Lainnya', 'urutan' => 30],
            ...
            ['bab_id' => 3, 'jepang' => 'せん', 'kanji' => '千', 'romaji' => 'sen', 'arti' => '1.000', 'kategori' => 'Angka', 'urutan' => 35],
            ['bab_id' => 3, 'jepang' => 'まん', 'kanji' => '万', 'romaji' => 'man', 'arti' => '10.000', 'kategori' => 'Angka', 'urutan' => 36],
            ['bab_id' => 3, 'jepang' => 'すみません', 'kanji' => null, 'romaji' => 'sumimasen', 'arti' => 'maaf/permisi', 'kategori' => 'Ekspresi', 'urutan' => 37],
            ['bab_id' => 3, 'jepang' => 'どうも', 'kanji' => null, 'romaji' => 'doumo', 'arti' => 'terima kasih (singkat)', 'kategori' => 'Ekspresi', 'urutan' => 38],
            ['bab_id' => 3, 'jepang' => 'いらっしゃいませ', 'kanji' => null, 'romaji' => 'irasshaimase', 'arti' => 'selamat datang', 'kategori' => 'Salam', 'urutan' => 39],
            ['bab_id' => 3, 'jepang' => '[〜を]みせてください', 'kanji' => '見せてください', 'romaji' => '~wo misete kudasai', 'arti' => 'tolong perlihatkan', 'kategori' => 'Ungkapan', 'urutan' => 40],
            ['bab_id' => 3, 'jepang' => 'じゃ', 'kanji' => null, 'romaji' => 'ja', 'arti' => 'kalau begitu', 'kategori' => 'Ekspresi', 'urutan' => 41],
            ['bab_id' => 3, 'jepang' => '[〜を]ください', 'kanji' => '下さい', 'romaji' => '~wo kudasai', 'arti' => 'tolong berikan', 'kategori' => 'Ungkapan', 'urutan' => 42],
